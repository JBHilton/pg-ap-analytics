...
smr_df <- read_xlsx("data-inputs/masterfile_111025.xlsx",
...
mortality_prob_by_age <- read_xlsx("data-inputs/masterfile_111025.xlsx",
                        sheet = "age_sex_dependant_mortality",
                        range = "A12:D52") %>%
...
markov_utils <- read_xlsx("data-inputs/masterfile_111025.xlsx",
                          sheet = "markov",
