...
ci_df <- data.frame(life_years_sc_mean = summarise(multi_results[1:n_sample, ], mean = mean(life_years_sc))$mean,
                    life_years_sc_L = summarise(multi_results[1:n_sample, ], q = quantile((life_years_sc), 0.025))$q,
                    life_years_sc_U = summarise(multi_results[1:n_sample, ], q = quantile((life_years_sc), 0.975))$q,
                    cost_udc_sc_mean = summarise(multi_results[1:n_sample, ], mean = mean(cost_udc_sc_hs))$mean,
                    cost_udc_sc_L = summarise(multi_results[1:n_sample, ], q = quantile((cost_udc_sc_hs), 0.025))$q,
                    cost_udc_sc_U = summarise(multi_results[1:n_sample, ], q = quantile((cost_udc_sc_hs), 0.975))$q,
                    util_udc_sc_mean = summarise(multi_results[1:n_sample, ], mean = mean(util_udc_sc_hs))$mean,
                    util_udc_sc_L = summarise(multi_results[1:n_sample, ], q = quantile((util_udc_sc_hs), 0.025))$q,
                    util_udc_sc_U = summarise(multi_results[1:n_sample, ], q = quantile((util_udc_sc_hs), 0.975))$q,
                    cost_sc_mean = summarise(multi_results[1:n_sample, ], mean = mean(cost_dc_sc_hs))$mean,
                    cost_sc_L = summarise(multi_results[1:n_sample, ], q = quantile((cost_dc_sc_hs), 0.025))$q,
                    cost_sc_U = summarise(multi_results[1:n_sample, ], q = quantile((cost_dc_sc_hs), 0.975))$q,
                    util_sc_mean = summarise(multi_results[1:n_sample, ], mean = mean(util_dc_sc_hs))$mean,
                    util_sc_L = summarise(multi_results[1:n_sample, ], q = quantile((util_dc_sc_hs), 0.025))$q,
                    util_sc_U = summarise(multi_results[1:n_sample, ], q = quantile((util_dc_sc_hs), 0.975))$q,
                    nmb_sc_mean = summarise(multi_results[1:n_sample, ], mean = mean(nmb_sc))$mean,
                    nmb_sc_L = summarise(multi_results[1:n_sample, ], q = quantile((nmb_sc), 0.025))$q,
                    nmb_sc_U = summarise(multi_results[1:n_sample, ], q = quantile((nmb_sc), 0.975))$q,
                    life_years_pc_mean = summarise(multi_results[1:n_sample, ], mean = mean(life_years_pc))$mean,
                    life_years_pc_L = summarise(multi_results[1:n_sample, ], q = quantile((life_years_pc), 0.025))$q,
                    life_years_pc_U = summarise(multi_results[1:n_sample, ], q = quantile((life_years_pc), 0.975))$q,
                    cost_udc_pc_mean = summarise(multi_results[1:n_sample, ], mean = mean(cost_udc_pc_hs))$mean,
                    cost_udc_pc_L = summarise(multi_results[1:n_sample, ], q = quantile((cost_udc_pc_hs), 0.025))$q,
                    cost_udc_pc_U = summarise(multi_results[1:n_sample, ], q = quantile((cost_udc_pc_hs), 0.975))$q,
                    util_udc_pc_mean = summarise(multi_results[1:n_sample, ], mean = mean(util_udc_pc_hs))$mean,
                    util_udc_pc_L = summarise(multi_results[1:n_sample, ], q = quantile((util_udc_pc_hs), 0.025))$q,
                    util_udc_pc_U = summarise(multi_results[1:n_sample, ], q = quantile((util_udc_pc_hs), 0.975))$q,
                    cost_pc_mean = summarise(multi_results[1:n_sample, ], mean = mean(cost_dc_pc_hs))$mean,
                    cost_pc_L = summarise(multi_results[1:n_sample, ], q = quantile((cost_dc_pc_hs), 0.025))$q,
                    cost_pc_U = summarise(multi_results[1:n_sample, ], q = quantile((cost_dc_pc_hs), 0.975))$q,
                    util_pc_mean = summarise(multi_results[1:n_sample, ], mean = mean(util_dc_pc_hs))$mean,
                    util_pc_L = summarise(multi_results[1:n_sample, ], q = quantile((util_dc_pc_hs), 0.025))$q,
                    util_pc_U = summarise(multi_results[1:n_sample, ], q = quantile((util_dc_pc_hs), 0.975))$q,
                    nmb_pc_mean = summarise(multi_results[1:n_sample, ], mean = mean(nmb_pc))$mean,
                    nmb_pc_L = summarise(multi_results[1:n_sample, ], q = quantile((nmb_pc), 0.025))$q,
                    nmb_pc_U = summarise(multi_results[1:n_sample, ], q = quantile((nmb_pc), 0.975))$q,
                    life_years_inc_mean = summarise(multi_results[1:n_sample, ], mean = mean(life_years_inc))$mean,
                    life_years_inc_L = summarise(multi_results[1:n_sample, ], q = quantile((life_years_inc), 0.025))$q,
                    life_years_inc_U = summarise(multi_results[1:n_sample, ], q = quantile((life_years_inc), 0.975))$q,
                    cost_udc_inc_mean = summarise(multi_results[1:n_sample, ], mean = mean(inc_cost_udc_hs))$mean,
                    cost_udc_inc_L = summarise(multi_results[1:n_sample, ], q = quantile((inc_cost_udc_hs), 0.025))$q,
                    cost_udc_inc_U = summarise(multi_results[1:n_sample, ], q = quantile((inc_cost_udc_hs), 0.975))$q,
                    util_udc_inc_mean = summarise(multi_results[1:n_sample, ], mean = mean(inc_util_udc_hs))$mean,
                    util_udc_inc_L = summarise(multi_results[1:n_sample, ], q = quantile((inc_util_udc_hs), 0.025))$q,
                    util_udc_inc_U = summarise(multi_results[1:n_sample, ], q = quantile((inc_util_udc_hs), 0.975))$q,
                    cost_inc_mean = summarise(multi_results[1:n_sample, ], mean = mean(inc_cost_dc_hs))$mean,
                    cost_inc_L = summarise(multi_results[1:n_sample, ], q = quantile((inc_cost_dc_hs), 0.025))$q,
                    cost_inc_U = summarise(multi_results[1:n_sample, ], q = quantile((inc_cost_dc_hs), 0.975))$q,
                    util_inc_mean = summarise(multi_results[1:n_sample, ], mean = mean(inc_util_dc_hs))$mean,
                    util_inc_L = summarise(multi_results[1:n_sample, ], q = quantile((inc_util_dc_hs), 0.025))$q,
                    util_inc_U = summarise(multi_results[1:n_sample, ], q = quantile((inc_util_dc_hs), 0.975))$q,
                    nmb_inc_mean = summarise(multi_results[1:n_sample, ], mean = mean(inc_nmb))$mean,
                    nmb_inc_L = summarise(multi_results[1:n_sample, ], q = quantile((inc_nmb), 0.025))$q,
                    nmb_inc_U = summarise(multi_results[1:n_sample, ], q = quantile((inc_nmb), 0.975))$q,
                    icer_mean = summarise(multi_results[1:n_sample, ], mean = mean(icer))$mean,
                    icer_L = summarise(multi_results[1:n_sample, ], q = quantile((icer), 0.025))$q,
                    icer_U = summarise(multi_results[1:n_sample, ], q = quantile((icer), 0.975))$q
)
