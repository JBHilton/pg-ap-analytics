...
if (SAVE_OUTPUTS){
  fwrite(baseline_results,
         file = "outputs/nstemi_scenario_central_estimate.csv")
}
...
ci_df <- data.frame(scenario = scenarios,
                    life_years_sc_mean = summarise(multi_results, mean = mean(life_years_sc), .by = scenario)$mean,
                    life_years_sc_L = summarise(multi_results, q = quantile((life_years_sc), 0.025), .by = scenario)$q,
                    life_years_sc_U = summarise(multi_results, q = quantile((life_years_sc), 0.975), .by = scenario)$q,
                    cost_udc_sc_mean = summarise(multi_results, mean = mean(cost_udc_sc_hs), .by = scenario)$mean,
                    cost_udc_sc_L = summarise(multi_results, q = quantile((cost_udc_sc_hs), 0.025), .by = scenario)$q,
                    cost_udc_sc_U = summarise(multi_results, q = quantile((cost_udc_sc_hs), 0.975), .by = scenario)$q,
                    util_udc_sc_mean = summarise(multi_results, mean = mean(util_udc_sc_hs), .by = scenario)$mean,
                    util_udc_sc_L = summarise(multi_results, q = quantile((util_udc_sc_hs), 0.025), .by = scenario)$q,
                    util_udc_sc_U = summarise(multi_results, q = quantile((util_udc_sc_hs), 0.975), .by = scenario)$q,
                    cost_sc_mean = summarise(multi_results, mean = mean(cost_dc_sc_hs), .by = scenario)$mean,
                    cost_sc_L = summarise(multi_results, q = quantile((cost_dc_sc_hs), 0.025), .by = scenario)$q,
                    cost_sc_U = summarise(multi_results, q = quantile((cost_dc_sc_hs), 0.975), .by = scenario)$q,
                    util_sc_mean = summarise(multi_results, mean = mean(util_dc_sc_hs), .by = scenario)$mean,
                    util_sc_L = summarise(multi_results, q = quantile((util_dc_sc_hs), 0.025), .by = scenario)$q,
                    util_sc_U = summarise(multi_results, q = quantile((util_dc_sc_hs), 0.975), .by = scenario)$q,
                    nmb_sc_mean = summarise(multi_results, mean = mean(nmb_sc), .by = scenario)$mean,
                    nmb_sc_L = summarise(multi_results, q = quantile((nmb_sc), 0.025), .by = scenario)$q,
                    nmb_sc_U = summarise(multi_results, q = quantile((nmb_sc), 0.975), .by = scenario)$q,
                    life_years_pc_mean = summarise(multi_results, mean = mean(life_years_pc), .by = scenario)$mean,
                    life_years_pc_L = summarise(multi_results, q = quantile((life_years_pc), 0.025), .by = scenario)$q,
                    life_years_pc_U = summarise(multi_results, q = quantile((life_years_pc), 0.975), .by = scenario)$q,
                    cost_udc_pc_mean = summarise(multi_results, mean = mean(cost_udc_pc_hs), .by = scenario)$mean,
                    cost_udc_pc_L = summarise(multi_results, q = quantile((cost_udc_pc_hs), 0.025), .by = scenario)$q,
                    cost_udc_pc_U = summarise(multi_results, q = quantile((cost_udc_pc_hs), 0.975), .by = scenario)$q,
                    util_udc_pc_mean = summarise(multi_results, mean = mean(util_udc_pc_hs), .by = scenario)$mean,
                    util_udc_pc_L = summarise(multi_results, q = quantile((util_udc_pc_hs), 0.025), .by = scenario)$q,
                    util_udc_pc_U = summarise(multi_results, q = quantile((util_udc_pc_hs), 0.975), .by = scenario)$q,
                    cost_pc_mean = summarise(multi_results, mean = mean(cost_dc_pc_hs), .by = scenario)$mean,
                    cost_pc_L = summarise(multi_results, q = quantile((cost_dc_pc_hs), 0.025), .by = scenario)$q,
                    cost_pc_U = summarise(multi_results, q = quantile((cost_dc_pc_hs), 0.975), .by = scenario)$q,
                    util_pc_mean = summarise(multi_results, mean = mean(util_dc_pc_hs), .by = scenario)$mean,
                    util_pc_L = summarise(multi_results, q = quantile((util_dc_pc_hs), 0.025), .by = scenario)$q,
                    util_pc_U = summarise(multi_results, q = quantile((util_dc_pc_hs), 0.975), .by = scenario)$q,
                    nmb_pc_mean = summarise(multi_results, mean = mean(nmb_pc), .by = scenario)$mean,
                    nmb_pc_L = summarise(multi_results, q = quantile((nmb_pc), 0.025), .by = scenario)$q,
                    nmb_pc_U = summarise(multi_results, q = quantile((nmb_pc), 0.975), .by = scenario)$q,
                    life_years_inc_mean = summarise(multi_results, mean = mean(life_years_inc), .by = scenario)$mean,
                    life_years_inc_L = summarise(multi_results, q = quantile((life_years_inc), 0.025), .by = scenario)$q,
                    life_years_inc_U = summarise(multi_results, q = quantile((life_years_inc), 0.975), .by = scenario)$q,
                    cost_udc_inc_mean = summarise(multi_results, mean = mean(inc_cost_udc_hs), .by = scenario)$mean,
                    cost_udc_inc_L = summarise(multi_results, q = quantile((inc_cost_udc_hs), 0.025), .by = scenario)$q,
                    cost_udc_inc_U = summarise(multi_results, q = quantile((inc_cost_udc_hs), 0.975), .by = scenario)$q,
                    util_udc_inc_mean = summarise(multi_results, mean = mean(inc_util_udc_hs), .by = scenario)$mean,
                    util_udc_inc_L = summarise(multi_results, q = quantile((inc_util_udc_hs), 0.025), .by = scenario)$q,
                    util_udc_inc_U = summarise(multi_results, q = quantile((inc_util_udc_hs), 0.975), .by = scenario)$q,
                    cost_inc_mean = summarise(multi_results, mean = mean(inc_cost_dc_hs), .by = scenario)$mean,
                    cost_inc_L = summarise(multi_results, q = quantile((inc_cost_dc_hs), 0.025), .by = scenario)$q,
                    cost_inc_U = summarise(multi_results, q = quantile((inc_cost_dc_hs), 0.975), .by = scenario)$q,
                    util_inc_mean = summarise(multi_results, mean = mean(inc_util_dc_hs), .by = scenario)$mean,
                    util_inc_L = summarise(multi_results, q = quantile((inc_util_dc_hs), 0.025), .by = scenario)$q,
                    util_inc_U = summarise(multi_results, q = quantile((inc_util_dc_hs), 0.975), .by = scenario)$q,
                    nmb_inc_mean = summarise(multi_results, mean = mean(inc_nmb), .by = scenario)$mean,
                    nmb_inc_L = summarise(multi_results, q = quantile((inc_nmb), 0.025), .by = scenario)$q,
                    nmb_inc_U = summarise(multi_results, q = quantile((inc_nmb), 0.975), .by = scenario)$q,
                    icer_mean = summarise(multi_results, mean = mean(icer), .by = scenario)$mean,
                    icer_L = summarise(multi_results, q = quantile((icer), 0.025), .by = scenario)$q,
                    icer_U = summarise(multi_results, q = quantile((icer), 0.975), .by = scenario)$q
)
if (SAVE_OUTPUTS){
  fwrite(ci_df,
         file = paste(SAVE_FILEPATH,
